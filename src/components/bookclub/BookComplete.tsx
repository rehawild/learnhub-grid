...
import { BookOpen, RotateCcw, LayoutGrid } from "lucide-react";

interface BookCompleteProps {
    score: number;
    total: number;
    onRestart: () => void;
    onBack: () => void;
...
export const BookComplete = ({ score, total, onRestart, onBack }: BookCompleteProps) => {
    return (
        <Card className="w-full max-w-md mx-auto text-center animate-in fade-in slide-in-from-bottom-8">
            ...
            <CardContent className="space-y-8">
                <div>
                    <p className="text-muted-foreground mb-2">Discussion Score</p>
