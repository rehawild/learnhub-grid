...
import { NegotiationScenario, NegotiationPhrase, NegotiationState, NegotiationMode } from "@/types/negotiation";
...
export const useNegotiation = () => {
    ...
    const selectScenario = useCallback((scenario: NegotiationScenario) => {
        setState({
            mode: 'learning',
    ...
    const setMode = useCallback((mode: NegotiationMode) => {
