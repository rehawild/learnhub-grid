...
import { PrepositionDeck, PrepositionState } from "@/types/prepositionpro";
import { toast } from "sonner";

export const usePrepositionPro = () => {
    const [state, setState] = useState<PrepositionState>({
        currentDeck: null,
        currentIndex: 0,
        correctCount: 0,
        isComplete: false,
    ...
    const selectDeck = (deck: PrepositionDeck) => {
        setState({
            currentDeck: deck,
            currentIndex: 0,
            correctCount: 0,
