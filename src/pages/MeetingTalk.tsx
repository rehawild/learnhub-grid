...
import { ArrowLeft, Handshake, Brain, BookOpen, GraduationCap, TrendingUp } from "lucide-react";
import { useMeetingTalk } from "@/hooks/useMeetingTalk";
import { meetingScenarios } from "@/data/meetingtalk/scenarios";
import { ScenarioSelector } from "@/components/meetingtalk/ScenarioSelector";
import { PhraseCard } from "@/components/meetingtalk/PhraseCard";
import { PracticeArea } from "@/components/meetingtalk/PracticeArea";
import { cn } from "@/lib/utils";

export default function MeetingTalk() {
    const {
        state,
        selectScenario,
        setMode,
            ...
            <div className="container max-w-5xl mx-auto px-4 py-8">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="text-muted-foreground">
                        {currentScenario ? currentScenario.title : "Master the art of business communication"}
                    </p>
                </div>
                ...
                {mode === 'selection' ? (
                    <div className="space-y-12 animate-in fade-in slide-in-from-bottom-8 duration-500">
                        <ScenarioSelector scenarios={meetingScenarios} onSelect={selectScenario} />
                    </div>
                ) : (
